...
const SvgLink = ({
    ...
    >
        ...
        />
        <path
            d="M8.627 9.015a4.93 4.93 0 0 1 5.676 1.669.824.824 0 0 1-1.317.986 3.292 3.292 0 0 0-3.784-1.113 3.29 3.29 0 0 0-1.176.757l-2.462 2.464a3.294 3.294 0 0 0 2.342 5.576c.86.007 1.689-.323 2.309-.92l1.4-1.402a.822.822 0 1 1 1.164 1.164l-1.406 1.408-.01.01a4.932 4.932 0 0 1-6.918-.06 4.941 4.941 0 0 1-.06-6.924l.01-.01 2.467-2.47c.5-.5 1.103-.888 1.765-1.135Z"
            fill="currentColor"
        />
    </svg>
);
