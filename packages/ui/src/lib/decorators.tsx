...
export const moralisContext: DecoratorFn = (Story) => {
  ...
  const Web3Initialize = () => {
    ...
    }, [isAuthenticated, isWeb3Enabled, isInitialized, isWeb3EnableLoading]);
  ...
  return (
    <>
      {MORALIS_APP_ID && MORALIS_SERVER_URL ? (
        ...
        <>
          <p>This component requires your Moralis Server connection!</p>
          <p>
            Rename .env.example to .env in the main folder and provide your
            appId and serverUrl from Moralis{" "}
            <a
