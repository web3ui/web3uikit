...
describe('Button - Primary', () => {
  ...
  it('renders the component', () => {
    const element = container.querySelector(`[data-testid="${buttonTestId}"]`);
...
describe('Button - Primary with icon', () => {
  ...
  it('renders icon correctly', () => {
    const iconElement = container.querySelector(`[data-testid="${buttonTestId}"] > div > svg`);
...
describe('Button - Link', () => {
  ...
  it('renders Warning button with correct styles', () => {
    const element = container.querySelector(`[data-testid="${buttonTestId}"]`);
    const styles = element && getComputedStyle(element);
    const bgColorHex = styles && styles.backgroundColor;
