  ...
  return (
    <>
      ...
      >
        ...
        <Button text='Success' onClick={() => handleNewNotification('success')} isFullWidth={true} theme='primary' />
        <Button
          text='Warning'
          ...
          color='yellow'
        />
        <Button text='Custom Icon' onClick={() => handleNewNotification('info', iconTypes.bell)} isFullWidth={true} />
      </div>
      <h3>Position:</h3>
      <div
        style={{
      ...
      >
        <Button
          text='bottomL'
          onClick={() => handleNewNotification('success', undefined, 'bottomL')}
          isFullWidth={true}
          theme='primary'
        />
        <Button
          text='bottomR'
          onClick={() => handleNewNotification('success', undefined, 'bottomR')}
          isFullWidth={true}
          theme='primary'
        />
        <Button
          text='topL'
          onClick={() => handleNewNotification('success', undefined, 'topL')}
          isFullWidth={true}
          theme='primary'
        />
      </div>
