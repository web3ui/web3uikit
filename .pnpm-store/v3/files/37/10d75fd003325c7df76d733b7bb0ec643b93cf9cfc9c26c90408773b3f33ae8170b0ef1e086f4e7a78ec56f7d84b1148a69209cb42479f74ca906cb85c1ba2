...
function filterAffected(graph, touchedFiles, workspaceJson = (0, configuration_1.readAllWorkspaceConfiguration)(), nxJson = (0, configuration_1.readNxJson)(), packageJson = (0, file_utils_1.readPackageJson)()) {
