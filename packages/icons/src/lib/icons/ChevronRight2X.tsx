...
const SvgChevronRight2X = ({
    ...
    >
        ...
        <path d="M17.882 11.735a.357.357 0 0 1 0 .53l-4.63 4.618c-.126.156-.378.156-.536 0l-.598-.624c-.157-.125-.157-.374 0-.53l3.717-3.713-3.717-3.745a.357.357 0 0 1 0-.53l.598-.624c.158-.156.41-.156.536 0l4.63 4.618z" />
