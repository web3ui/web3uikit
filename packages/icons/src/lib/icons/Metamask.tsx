...
const SvgMetamask = ({
    ...
    >
        ...
        />
        <path
            d="m14.367 8.79-3.068-2.73-.1 4.795 4.404-.2-1.236-1.866z"
            fill="url(#metamask_svg__k)"
        />
        <path
            d="m5.874 17.33 2.666-1.287-2.295-1.788-.371 3.075zm5.586-1.287 2.659 1.287-.363-3.075-2.296 1.788z"
            fill="#E27625"
        />
        <path
        ...
        />
        <path
            d="m5.873 17.33.387-3.175-2.458.069 2.071 3.106zm7.867-3.175.379 3.175 2.079-3.106-2.458-.07zm1.863-3.5-4.405.2.41 2.259.649-1.365 1.569.717 1.777-1.811zm-9.42 1.811 1.56-.717.65 1.365.41-2.259-4.406-.2 1.786 1.811z"
            fill="#CC6228"
        />
        <path
            d="m4.397 10.655 1.847 3.6-.061-1.789-1.786-1.811zm9.429 1.811-.07 1.789 1.847-3.6-1.777 1.811zm-5.023-1.611-.41 2.259.518 2.667.116-3.515-.224-1.41zm2.394 0-.216 1.403.108 3.523.518-2.667-.41-2.259z"
            fill="#E27525"
        />
        <path
