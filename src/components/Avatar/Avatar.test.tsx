...
describe('Avatar - Letters', () => {
  ...
  it('renders the component', () => {
    const element = container.querySelector(`[data-testid="${testAvatarId}"]`);
    expect(element).not.toBeNull();
  });

  it('renders the text', () => {
    const element = container.querySelector(`[data-testid="${testTextId}"]`);
...
describe('Avatar - Custom Image', () => {
  ...
  it('renders the custom image', () => {
    const element = container.querySelector(`[data-testid="${testImageId}"]`);
