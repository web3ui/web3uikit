...
const DivStyledTooltipText = styled.div<Pick<TooltipProps, 'maxWidth' | 'minWidth'>>`
...
export const DivStyledArrow = styled.div<Pick<TooltipProps, 'position' | 'move' | 'moveBody'>>`
