...
var TSDocEmitter = /** @class */ (function () {
    ...
    TSDocEmitter.prototype._renderNode = function (docNode) {
        ...
        switch (docNode.kind) {
            case nodes_1.DocNodeKind.Block:
                ...
                break;
            case nodes_1.DocNodeKind.BlockTag:
            ...
            case nodes_1.DocNodeKind.CodeSpan:
                ...
                this._writeContent('`');
                break;
            case nodes_1.DocNodeKind.Comment:
                ...
                break;
            case nodes_1.DocNodeKind.DeclarationReference:
                ...
                break;
            case nodes_1.DocNodeKind.ErrorText:
            ...
            case nodes_1.DocNodeKind.FencedCode:
                ...
                this._writeNewline();
                break;
            case nodes_1.DocNodeKind.HtmlAttribute:
                ...
                break;
            case nodes_1.DocNodeKind.HtmlEndTag:
                var docHtmlEndTag = docNode;
                this._writeContent('</');
                this._writeContent(docHtmlEndTag.name);
                this._writeContent('>');
                break;
            case nodes_1.DocNodeKind.HtmlStartTag:
                ...
                break;
            case nodes_1.DocNodeKind.InheritDocTag:
                ...
                break;
            case nodes_1.DocNodeKind.InlineTag:
            ...
            case nodes_1.DocNodeKind.LinkTag:
                ...
                break;
            case nodes_1.DocNodeKind.MemberIdentifier:
                ...
                break;
            case nodes_1.DocNodeKind.MemberReference:
            ...
            case nodes_1.DocNodeKind.Paragraph:
                ...
                break;
            case nodes_1.DocNodeKind.ParamBlock:
                ...
                this._hangingParagraph = false;
                break;
            case nodes_1.DocNodeKind.ParamCollection:
