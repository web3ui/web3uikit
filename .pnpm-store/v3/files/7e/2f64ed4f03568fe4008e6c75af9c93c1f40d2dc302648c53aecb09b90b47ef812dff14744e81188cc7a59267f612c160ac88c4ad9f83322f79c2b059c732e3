...
function directoryExists(name) {
    try {
        return (0, fs_2.statSync)(name).isDirectory();
    }
    catch (e) {
        return false;
    }
...
function createDirectory(directoryPath) {
    const parentPath = (0, path_2.resolve)(directoryPath, '..');
    if (!directoryExists(parentPath)) {
        createDirectory(parentPath);
    }
    if (!directoryExists(directoryPath)) {
        (0, fs_2.mkdirSync)(directoryPath);
    }
}
...
function extractFileFromTarball(tarballPath, file, destinationFilePath) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            (0, fs_extra_1.ensureDirSync)((0, path_1.dirname)(destinationFilePath));
