export default {
    ...
    cronos: 'linear-gradient(113.54deg, rgba(45, 69, 104, 0.531738) 14.91%, rgba(0, 4, 48, 0.6) 42.57%, rgba(45, 65, 104, 0.336) 45.98%, rgba(0, 4, 48, 0.03) 55.76%), linear-gradient(160.75deg, #000430 41.37%, #173869 98.29%);',
    coinbase:
