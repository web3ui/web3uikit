...
function runOne(cwd, args, extraTargetDependencies = {}) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const { nxArgs, overrides } = (0, command_line_utils_1.splitArgsIntoNxArgsAndOverrides)(Object.assign(Object.assign({}, opts.parsedArgs), { configuration: opts.configuration, target: opts.target }), 'run-one', { printWarnings: true }, env.nxJson);
        if (nxArgs.help) {
        ...
        yield (0, run_command_1.runCommand)(projects, projectGraph, env, nxArgs, overrides, opts.project, extraTargetDependencies);
    });
}
