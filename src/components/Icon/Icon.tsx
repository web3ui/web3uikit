        ...
        const getIcon = (fill: string, size: string | number, svg: string) => {
                switch (svg) {
                        case 'arrow circle down':
                                return collection?.arrowCircleDownIcon(
                                        fill,
                                        size,
                                );
                        case 'arrow circle left':
                                return collection?.arrowCircleLeftIcon(
                                        fill,
                                        size,
                                );
                        case 'arrow circle right':
                                return collection?.arrowCircleRightIcon(
                                        fill,
                                        size,
                                );
                        case 'bell':
                        ...
                        case 'chevron left x2':
                                return collection?.chevronLeftX2Icon(
                                        fill,
                                        size,
                                );
                        case 'chevron right':
                        ...
                        case 'chevron right x2':
                                return collection?.chevronRightX2Icon(
                                        fill,
                                        size,
                                );
                        case 'cloud':
                        ...
                        case 'download cloud':
                                return collection?.downloadCloudIcon(
                                        fill,
                                        size,
                                );
                        case 'edit':
                        ...
                        case 'message circle':
                                return collection?.messageCircleIcon(
                                        fill,
                                        size,
                                );
                        case 'minimize':
