(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./comment_char.js", "./utils/string_utils.js"], factory);
    }
})(function (require, exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
    const comment_char_js_1 = require("./comment_char.js");
    ...
    class CodeBlockWriter {
        ...
        closeComment() {
            ...
            switch (commentChar) {
                case comment_char_js_1.CommentChar.Line:
                    this.newLine();
                    break;
                case comment_char_js_1.CommentChar.Star:
                    if (!this.isLastNewLine()) {
                        this.spaceIfLastNot();
                    }
                    this.write("*/");
        ...
        /** @internal */
        _baseWriteNewline() {
            if (this._currentCommentChar === comment_char_js_1.CommentChar.Line) {
        ...
        _updateInternalState(str) {
            for (let i = 0; i < str.length; i++) {
                ...
                if (this._currentCommentChar == null && pastChar === CHARS.FORWARD_SLASH && currentChar === CHARS.FORWARD_SLASH) {
                    this._currentCommentChar = comment_char_js_1.CommentChar.Line;
                }
                else if (this._currentCommentChar == null && pastChar === CHARS.FORWARD_SLASH && currentChar === CHARS.ASTERISK) {
                    this._currentCommentChar = comment_char_js_1.CommentChar.Star;
                }
                else if (this._currentCommentChar === comment_char_js_1.CommentChar.Star && pastChar === CHARS.ASTERISK && currentChar === CHARS.FORWARD_SLASH) {
                    this._currentCommentChar = undefined;
                }
                if (this.isInComment()) {
                    continue;
