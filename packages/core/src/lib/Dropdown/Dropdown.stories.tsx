  ...
  options: [
    {
      label: 'Api Key',
      id: 'Api Key',
      prefix: <Avatar borderRadius={7.5} text={'Hi'} theme='letters' avatarKey={1} size={24} fontSize={8} />
    },
    {
      label: 'Testnet',
      id: 'Testnet',
      prefix: <Avatar borderRadius={7.5} text={'Hi'} theme='letters' size={24} avatarKey={2} fontSize={8} />
    },
    {
      label: 'Mainent',
      id: 'Mainent',
      prefix: <Avatar borderRadius={7.5} text={'Hi'} theme='letters' size={24} avatarKey={3} fontSize={8} />
    }
  ]
};
