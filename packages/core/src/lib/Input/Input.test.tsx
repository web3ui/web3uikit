...
describe('Input - Text', () => {
  ...
  beforeEach(() => {
    ...
    render(<DefaultInput onChange={(event: React.ChangeEvent<HTMLInputElement>) => testEvent(event.target)} />, {
  ...
  it('renders the component', () => {
    const input: HTMLInputElement | null = container.querySelector(`[data-testid="${testInputId}"]`);
  ...
  it('renders input correct colors', () => {
    const input: HTMLInputElement | null = container.querySelector(`[data-testid="${testDivId}"]`);
    const styles = input && getComputedStyle(input);
    expect(rgbToHex(styles?.outlineColor).toUpperCase()).toBe(color.greyLight);
  });
...
describe('Input - Text Error', () => {
  ...
  beforeEach(() => {
    ...
    render(<InputError onChange={(event: React.ChangeEvent<HTMLInputElement>) => testEvent(event.target)} />, {
      container: document.body.appendChild(container)
    });
  });
  afterEach(() => {
...
describe('Input - Text Confirmed', () => {
  ...
  beforeEach(() => {
    ...
    render(<InputConfirmed onChange={(event: React.ChangeEvent<HTMLInputElement>) => testEvent(event.target)} />, {
      container: document.body.appendChild(container)
    });
  });
  afterEach(() => {
...
describe('Input - Number', () => {
  ...
  beforeEach(() => {
    ...
    render(<NumberInput onChange={(event: React.ChangeEvent<HTMLInputElement>) => testEvent(event.target)} />, {
      container: document.body.appendChild(container)
    });
  });
  afterEach(() => {
...
describe('Input - Password', () => {
  ...
  beforeEach(() => {
    ...
    render(<PasswordInput onChange={(event: React.ChangeEvent<HTMLInputElement>) => testEvent(event.target)} />, {
      container: document.body.appendChild(container)
    });
  });
  afterEach(() => {
...
describe('Input - Email', () => {
  ...
  beforeEach(() => {
    ...
    render(<EmailInput onChange={(event: React.ChangeEvent<HTMLInputElement>) => testEvent(event.target)} />, {
      container: document.body.appendChild(container)
    });
  });
  afterEach(() => {
...
describe('Input - Tel', () => {
  ...
  beforeEach(() => {
    ...
    render(<TelInput onChange={(event: React.ChangeEvent<HTMLInputElement>) => testEvent(event.target)} />, {
      container: document.body.appendChild(container)
    });
  });
  afterEach(() => {
...
describe('Validation - Number Range', () => {
  ...
  it('validates a the valid input', async () => {
    const goodValue = Number(ValidateNumberRange?.args?.validation?.numberMax) - 1;
    const input: HTMLInputElement | null = container.querySelector(`[data-testid="${testInputId}"]`);
    expect(input).not.toBeNull();
  ...
  it('validates a the non valid input', async () => {
    const badValue = Number(ValidateNumberRange?.args?.validation?.numberMax) + 1;
    const input: HTMLInputElement | null = container.querySelector(`[data-testid="${testInputId}"]`);
    expect(input).not.toBeNull();
