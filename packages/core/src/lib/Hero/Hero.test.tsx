...
const testBgURL = 'https://moralis.io/wp-content/uploads/2021/07/hero_new_img.svg';
...
describe('Hero - customized height', () => {
  it('renders the component', () => {
    render(<Hero title={testTitle} backgroundURL={testBgURL} height={testHeight} />);
    const element = screen.getByTestId('test-hero');
    expect(element).not.toBeNull();
  });
  ...
  it('renders the component with sub title', () => {
    render(<Hero title={testTitle} backgroundURL={testBgURL} subTitle={testSubTitle} />);
  ...
  it('renders the component with children', () => {
    render(<Hero title={testTitle} backgroundURL={testBgURL} children={testChildren} />);
