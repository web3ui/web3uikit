...
const SvgUpdate = ({
    ...
    >
        ...
        />
        <path
            d="M15.399 3.437a.626.626 0 0 1 0 1.08l-2.87 2.35a.628.628 0 0 1-.948-.54v-4.7c0-.484.529-.785.947-.54l2.87 2.35ZM15.873 8.78a.886.886 0 0 1 0 1.256l-4.5 4.49a.89.89 0 0 1-1.258 0l-1.988-1.984a.886.886 0 0 1 0-1.255.89.89 0 0 1 1.258 0l1.36 1.356 3.87-3.863a.89.89 0 0 1 1.258 0Z"
            fill="currentColor"
        />
    </svg>
);
