 ...
 */
function findExportedComponentDefinition(ast, _parser, importer) {
    let foundDefinition = null;
    function exportDeclaration(path) {
        const definitions = (0, resolveExportDeclaration_1.default)(path, importer).reduce((acc, definition) => {
