...
export const header = ['', <span>Name</span>, <span>Type</span>, <span>Module</span>, ''];
export const data = [
  [
...
export const syncHeader = [<span>Description</span>, <span>Last Synced</span>, <span>Queue</span>, ''];
...
export const syncData = [
  [
    ...
    <>
      <Button isTransparent disabled text='Edit' color='blue' size='small' />
      <Button isTransparent disabled iconLayout='icon-only' iconColor='red' icon='x' />
    </>
  ],
  [
    <>
